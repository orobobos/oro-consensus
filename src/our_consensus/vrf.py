...
**Why this is acceptable for validator selection:**
...
class VRF:
    ...
    SIMPLIFIED CONSTRUCTION - See module docstring for security analysis.
        ...
        Security Properties (verified by design):
            - Deterministic: Ed25519 uses deterministic nonces (RFC 8032 S5.1.6)
    ...
    def verify(
        ...
        try:
            ...
            expected_ticket = hashlib.sha512(DOMAIN_SEPARATOR_VRF_HASH + signature + input_hash).digest()[
                :VRF_OUTPUT_SIZE
            ]
