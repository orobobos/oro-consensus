...
class ValidatorTier(StrEnum):
    ...
    STANDARD = "standard"  # 0.10-0.30 stake, 1.0x weight
    ENHANCED = "enhanced"  # 0.30-0.50 stake, 1.5x weight
    GUARDIAN = "guardian"  # 0.50-0.80 stake, 2.0x weight
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "transition_completed_at": (
                self.transition_completed_at.isoformat() if self.transition_completed_at else None
            ),
        }
